...
namespace Foxoft
{
    partial class FormCurrAccPermission
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((ISupportInitialize)layoutControlItemCurrAccCode).BeginInit();
            ((ISupportInitialize)layoutControlItemCurrAccDesc).BeginInit();
            ((ISupportInitialize)groupRoles).BeginInit();
            ((ISupportInitialize)layoutControlItemRolesGrid).BeginInit();
            ((ISupportInitialize)layoutControlItemSaveRoles).BeginInit();
            ...
            ribbon.Items.AddRange(new BarItem[] { ribbon.ExpandCollapseItem, BBI_Save, BBI_Refresh, BBI_SelectAllRoles, BBI_UnselectAllRoles, BBI_NewRole, BBI_EditRole, BBI_DeleteRole, BBI_RoleClaimsWindow, BBI_SetPassword });
            ...
            BBI_NewRole.Id = 5;
            BBI_NewRole.ImageOptions.SvgImage = (DevExpress.Utils.Svg.SvgImage)resources.GetObject("BBI_NewRole.ImageOptions.SvgImage");
            ...
            BBI_EditRole.Id = 6;
            BBI_EditRole.ImageOptions.SvgImage = (DevExpress.Utils.Svg.SvgImage)resources.GetObject("BBI_EditRole.ImageOptions.SvgImage");
            ...
            BBI_DeleteRole.Id = 7;
            BBI_DeleteRole.ImageOptions.SvgImage = (DevExpress.Utils.Svg.SvgImage)resources.GetObject("BBI_DeleteRole.ImageOptions.SvgImage");
            ...
            Root.Items.AddRange(new BaseLayoutItem[] { layoutControlItemCurrAccCode, layoutControlItemCurrAccDesc, groupRoles });
            Root.Name = "Root";
            ...
            // groupRoles
            // 
            groupRoles.Items.AddRange(new BaseLayoutItem[] { layoutControlItemRolesGrid, layoutControlItemSaveRoles });
            ...
            xtraTabControl1.TabPages.AddRange(new XtraTabPage[] { tab_RoleClaims, tab_EffectiveClaims, tab_ReportClaims });
            ...
            // 
            treeListEffectiveClaims.Columns.AddRange(new TreeListColumn[] { colEff_IsSelected, colEff_CategoryDesc, colEff_ClaimDesc, colEff_ClaimCode, colEff_CategoryId, colEff_CategoryParentId, colEff_IsCategory });
            ...
            lbl_EffectiveSummary.Size = new Size(0, 13);
            ...
            // 
            treeListReportClaims.Columns.AddRange(new TreeListColumn[] { colReport_IsSelected, colReport_ReportId, colReport_ReportName, colReport_ClaimCode });
            ...
            repoCheckEditReport.EditValueChanged += repoCheckEditReport_EditValueChanged;
            // 
            // colReport_ReportId
            // 
            ...
            ((ISupportInitialize)layoutControlItemCurrAccCode).EndInit();
            ((ISupportInitialize)layoutControlItemCurrAccDesc).EndInit();
            ((ISupportInitialize)groupRoles).EndInit();
            ((ISupportInitialize)layoutControlItemRolesGrid).EndInit();
            ((ISupportInitialize)layoutControlItemSaveRoles).EndInit();
