...
namespace Foxoft.Migrations
{
    ...
    [Migration("20260120201616_hrModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foxoft.Models.DcEmployee", b =>
                {
                    b.Property<string>("CurrAccCode")
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("Foxoft.Models.DcLeaveType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Foxoft.Models.TrEmployeeEducation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TrEmployeeEducations");
                });
            ...
            modelBuilder.Entity("Foxoft.Models.TrLeave", b =>
                {
                    ...
                    b.Property<string>("ApprovedByCurrAccCode")
                        .HasColumnType("nvarchar(30)");
                    ...
                    b.HasIndex("ApprovedByCurrAccCode");
            ...
            modelBuilder.Entity("Foxoft.Models.DcEmployee", b =>
                {
                    b.HasOne("Foxoft.Models.DcCurrAcc", "DcCurrAcc")
                        .WithOne("DcEmployee")
                        .HasForeignKey("Foxoft.Models.DcEmployee", "CurrAccCode")
            ...
            modelBuilder.Entity("Foxoft.Models.TrAttendance", b =>
                {
                    b.HasOne("Foxoft.Models.DcEmployee", "Employee")
            ...
            modelBuilder.Entity("Foxoft.Models.TrLeave", b =>
                {
                    b.HasOne("Foxoft.Models.DcEmployee", "ApprovedByEmployee")
                        .WithMany("ApprovedLeaves")
                        .HasForeignKey("ApprovedByCurrAccCode")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Foxoft.Models.DcLeaveType", "LeaveType")
                        .WithMany("Leaves")
