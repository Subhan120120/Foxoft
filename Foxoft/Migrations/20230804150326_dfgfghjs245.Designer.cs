...
namespace Foxoft.Migrations
{
    ...
    [Migration("20230804150326_dfgfghjs245")]
    partial class dfgfghjs245
    {
            ...
            modelBuilder.Entity("Foxoft.Models.DcProduct", b =>
                {
                    ...
                    b.HasIndex("SiteProductId")
                        .IsUnique()
                        .HasFilter("[SiteProductId] IS NOT NULL");
            ...
            modelBuilder.Entity("Foxoft.Models.DcProduct", b =>
                {
                    ...
                    b.HasOne("Foxoft.Models.SiteProduct", "SiteProduct")
                        .WithOne()
                        .HasForeignKey("Foxoft.Models.DcProduct", "SiteProductId")
                        .OnDelete(DeleteBehavior.Restrict);
