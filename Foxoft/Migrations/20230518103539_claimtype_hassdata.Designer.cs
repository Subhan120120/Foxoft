...
namespace Foxoft.Migrations
{
    ...
    [Migration("20230518103539_claimtype_hassdata")]
    partial class claimtype_hassdata
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foxoft.Models.DcClaim", b =>
                {
                    ...
                    b.Property<byte?>("dcClaimTypeClaimTypeCode")
                        .HasColumnType("tinyint");

                    b.HasKey("ClaimCode");

                    b.HasIndex("dcClaimTypeClaimTypeCode");
            ...
            modelBuilder.Entity("Foxoft.Models.DcClaim", b =>
                {
                    b.HasOne("Foxoft.Models.dcClaimType", null)
                        .WithMany("DcClaims")
                        .HasForeignKey("dcClaimTypeClaimTypeCode")
                        .OnDelete(DeleteBehavior.Restrict);
                });
