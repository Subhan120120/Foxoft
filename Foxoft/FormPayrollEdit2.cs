...
namespace Foxoft
{
    public class FormPayrollEdit2 : XtraForm
    {
        ...
        public FormPayrollEdit2(Guid? payrollHeaderId)
        {
            id = payrollHeaderId;
        ...
        private void BtnEditPeriod_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            //{
            //    //BtnEditPeriod.EditValue = formCommonList.;
            //}

            FormCommonList<DcPayrollPeriod> formCommonList = new("", nameof(DcPayrollPeriod.Id), btnEditPeriod.EditValue?.ToString());
            if (formCommonList.ShowDialog() == DialogResult.OK)
            {
                btnEditPeriod.EditValue = formCommonList.Value_Id;
            }
        }
        ...
        private void Save()
        {
            ...
            entity.PayrollPeriodId = Guid.Parse(btnEditPeriod.EditValue.ToString());
