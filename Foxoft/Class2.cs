    ...
    internal class Class2
    {
        public Class2()
        {
            string query = @"
                    ...
                    Select Top 2147483647  DcProducts.ProductCode
                    , [Məhsulun Geniş Adı] = isnull(DcHierarchies.HierarchyCode + ' ','')  + ProductDesc +  isnull(' ' + Feature04,'') + isnull(' ' + Feature05,'') 
                    , ProductDesc
                    , WholesalePrice
                    ...
                    order by isnull(DcHierarchies.HierarchyCode + ' ','')  + ProductDesc +  isnull(' ' + Feature04,'') +  isnull(' ' + Feature05Desc,'') 
            ...
            string queryMaster = "select * from (" + query + ") as Master ";

            string queryMasterFiltered = queryMaster + filter;
