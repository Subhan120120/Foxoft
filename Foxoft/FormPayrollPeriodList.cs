// File: Forms/Hr/FormPayrollPeriodList.cs
...
namespace Foxoft
{
    public class FormPayrollPeriodList : RibbonForm
    {
        ...
        public FormPayrollPeriodList()
        {
            ...
            var group = new RibbonPageGroup("Payroll Periods");
        ...
        private void LoadData()
        {
            var list = db.DcPayrollPeriods.AsNoTracking()
                ...
                .Select(x => new { x.Id, x.PeriodYear, x.PeriodMonth, x.IsClosed })
                .ToList();
        ...
        private void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show(this, "Delete selected payroll period?", "Confirm",
