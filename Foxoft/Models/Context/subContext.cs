    ...
    public partial class subContext : DbContext
    {
        ...
        private static void InitializeDeleteBehaviour(ModelBuilder modelBuilder)
        {
            foreach (var foreignKey in modelBuilder.Model.GetEntityTypes().SelectMany(e => e.GetForeignKeys()))
            {
                ...
                {
                    var deleteBehaviorAttr = CustomAttributeExtensions.GetCustomAttribute<DeleteBehaviorAttribute>(navigation.PropertyInfo);
                    if (deleteBehaviorAttr != null)
                    {
                        foreignKey.DeleteBehavior = deleteBehaviorAttr.Behavior;
                        continue;
                    }
                }
        ...
        private static void InitializeHasData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DcForm>().HasData(
                ...
                new DcForm { FormCode = "InstallmentSale", FormDesc = "Taksit Satış" },
            ...
            modelBuilder.Entity<DcClaimCategory>().HasData(
                ...
                new DcClaimCategory { CategoryId = 7,/*dəyişmə olmaz*/ CategoryDesc = "Taksit Alış", CategoryLevel = 1, CategoryParentId = 2 },
                new DcClaimCategory { CategoryId = 8,/*dəyişmə olmaz*/ CategoryDesc = "Taksit Satış", CategoryLevel = 1, CategoryParentId = 2 },
            ...
            modelBuilder.Entity<DcClaim>().HasData(
                ...
                new DcClaim { ClaimCode = "InstallmentPurchaseInvoice", ClaimDesc = "Taksit Alışı", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "InstallmentSaleInvoice", ClaimDesc = "Taksit Satışı", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "InstallmentPurchaseOrder", ClaimDesc = "Taksit Alış Sifarişi", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "InstallmentSaleOrder", ClaimDesc = "Taksit Satış Sifarişi", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "InstallmentPurchaseReturn", ClaimDesc = "Taksit Alış Qaytarması", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "InstallmentSaleReturn", ClaimDesc = "Taksit Satış Qaytarması", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "DeleteInvoiceIP", ClaimDesc = "Taksit Alış Fakturası Silmə", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "DeleteInvoiceIS", ClaimDesc = "Taksit Satış Fakturası Silmə", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "DeleteInvoiceIPO", ClaimDesc = "Taksit Alış Sifarişi Silmə", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "DeleteInvoiceISO", ClaimDesc = "Taksit Satış Sifarişi Silmə", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "DeleteLineIP", ClaimDesc = "Taksit Alış Sətiri Silmə", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "DeleteLineIS", ClaimDesc = "Taksit Satış Sətiri Silmə", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "DeleteLineIPO", ClaimDesc = "Taksit Alış Sifarişi Sətiri Silmə", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "DeleteLineISO", ClaimDesc = "Taksit Satış Sifarişi Sətiri Silmə", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "InstallmentCommissionChange", ClaimDesc = "Taksitin Kamissiyasını Dəyişmə", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "ChangePriceIP", ClaimDesc = "Taksit Alış Qiymət Dəyişmə", ClaimTypeId = 1, CategoryId = 7 },
                new DcClaim { ClaimCode = "ChangePriceIS", ClaimDesc = "Taksit Alış Qiymət Dəyişmə", ClaimTypeId = 1, CategoryId = 8 },
                ...
                new DcClaim { ClaimCode = "LoyaltyPrograms", ClaimDesc = "Loyallıq Proqramları", ClaimTypeId = 1, CategoryId = 19 },
            ...
            modelBuilder.Entity<DcReport>().HasData(
                ...
                new DcReport { ReportId = 22, ReportTypeId = 1, ReportCategoryId = 2, ReportName = "Bonus Jurnalı", ReportQuery = cM.GetDataFromFile("Foxoft.AppCode.Report." + "Report_Grid_LoyaltyLedger.sql"), ReportLayout = "" }
            ...
            modelBuilder.Entity<DcProcess>().HasData(
                ...
                new DcProcess { ProcessCode = "IS", ProcessDesc = "Taksit Satışı", ProcessDir = 2 }
                );
            ...
            modelBuilder.Entity<DcVariable>().HasData(
                ...
                new DcVariable { VariableCode = "IS", VariableDesc = "Taksit Satışı" },
