// File: Forms/Hr/FormEmployeePositionList.cs
...
namespace Foxoft
{
    public class FormEmployeePositionList : RibbonForm
    {
        ...
        public FormEmployeePositionList()
        {
            ...
            var group = new RibbonPageGroup("Employee Positions");
        ...
        private void LoadData()
        {
            var list = db.TrEmployeePositions.AsNoTracking()
                ...
                .Include(x => x.Position).ThenInclude(p => p.Department)
                .OrderByDescending(x => x.StartDate)
                .Select(x => new
                {
                    x.Id,
                    Employee = x.DcCurrAcc.CurrAccCode + " - " + x.DcCurrAcc.FirstName + " " + x.DcCurrAcc.LastName,
                    Department = x.Position.Department.DepartmentName,
        ...
        private void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show(this, "Delete selected record?", "Confirm",
