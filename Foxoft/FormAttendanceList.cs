// File: Forms/Hr/FormAttendanceList.cs
...
namespace Foxoft
{
    public class FormAttendanceList : RibbonForm
    {
        ...
        public FormAttendanceList()
        {
            ...
            var group = new RibbonPageGroup("Attendance");
        ...
        private void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show(this, "Delete selected attendance record?", "Confirm",
