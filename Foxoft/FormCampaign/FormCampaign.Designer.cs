...
namespace Foxoft
{
    partial class FormCampaign
    {
        ...
        private MyGridControl gC_Product;
        private MyGridView gV_Product;
        private MyGridControl gC_Category;
        private MyGridView gV_Category;
        private MyGridControl gC_Customer;
        private MyGridView gV_Customer;
        private MyGridControl gC_Store;
        private MyGridView gV_Store;
        private MyGridControl gC_Warehouse;
        private MyGridView gV_Warehouse;
        private MyGridControl gC_PaymentMethod;
        private MyGridView gV_PaymentMethod;
