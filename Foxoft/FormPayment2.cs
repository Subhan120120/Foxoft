...
namespace Foxoft
{
    public partial class FormPayment2 : XtraForm
    {
        public FormPayment2()
        {
            InitializeComponent();
        ...
        private void FormPayment2_Load(object sender, EventArgs e)
        {
            InitializeInputPad();
        ...
        private void btn_Num_Click(object sender, EventArgs e)
        {
            ...
            switch (key)
            {
                ...
                case "C": this.ActiveControl.Focus();  SendKeys.Send("^A"); SendKeys.Send("{BACKSPACE}"); break;
